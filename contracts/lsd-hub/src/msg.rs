...
pub struct InstantiateMsg {
    ...
    /// E.g. if this is `0.01 = 1%`, the stored value is `100` and the queried value is `99`, the validator is considered tombstoned.
...
pub enum ExecuteMsg {
    ...
    /// Triggers slashing detection, updating the exchange rate
    CheckSlash {},
